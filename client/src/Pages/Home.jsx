            ...
            <div className='flex flex-col gap-20'>
                <div className='flex w-full mr-4 gap-3 items-center'>
                    ...
                    <div className='w-2/4 justify-items-start'>
                        <h1 className='text-4xl font-bold'>Student's Hub</h1>
                ...
                <footer className='bg-customPink-50 w-full h-56 '>
                    <div className='flex mt-12 justify-evenly'>
                        <div className='w-5/12'>
                            ...
                            <p className='mt-2'>Student's Hub is a one stop solution created by students for students for both academics as well as social interaction.</p>
                        </div>
                        <div>
